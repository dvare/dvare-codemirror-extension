...
(function (mod) {
    ...
    def("text/x-dvare", {
        ...
        keywords: words("assign update Invoke invoke Function function fun " +
            ...
            "addMonths AddDays addDays GetYears getYears SetYear setYear SetMonth setMonth SetDay setDay " +
        ...
        defKeywords: words("Def def let Let"),
